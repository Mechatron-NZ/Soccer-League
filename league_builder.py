...
def build_teams(player_roster, team_names):
    ...
    league = [] # list of player lists (team_names number of teams in league)
    ...
    with open('Team-Roster.csv', 'w', newline="\n") as csvfile:
...
if __name__ == "__main__":
    ...
    # (also creates a csv file with sorted teams Team-Roster.csv)
